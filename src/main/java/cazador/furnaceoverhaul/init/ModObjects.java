...
public class ModObjects {
	...
	public static void items(Register<Item> e) {
		...
		registerItems(e.getRegistry(),
				...
				new ItemUpgrade("efficiency_upgrade", null),
				new ItemUpgrade("ore_processing_upgrade", null),
				new ItemUpgrade("liquid_fuel_upgrade", null),
				new ItemUpgrade("electric_fuel_upgrade", null),
				new ItemUpgrade("speed_upgrade", null),
				new ItemUpgrade("processing_upgrade", null),
